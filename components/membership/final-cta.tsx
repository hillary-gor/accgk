...
export default function FinalCta() {
  return (
    <div className="bg-teal-50 rounded-xl p-8 md:p-12 text-center">
      <h2 className="text-3xl font-bold text-[#3F96E6] mb-4">Secure Your Membership Today</h2>
      ...
      <Button asChild size="lg" className="bg-[#3F96E6] hover:bg-teal-700 mb-8">
        <Link href="/membership/join">Join Now</Link>
      </Button>

      <div className="flex flex-col sm:flex-row items-center justify-center gap-4 text-gray-600">
        <div className="flex items-center">
          <Mail className="h-5 w-5 text-[#3F96E6] mr-2" />
          <span>membership@accgk.co.ke</span>
        </div>
        <div className="hidden sm:block">•</div>
        <div className="flex items-center">
          <Phone className="h-5 w-5 text-[#3F96E6] mr-2" />
