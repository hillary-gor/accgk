  ...
  return (
    <div className="mb-16">
      <div className="text-center mb-10">
        <h2 className="text-3xl font-bold text-[#3F96E6] mb-4">How to Become a Member</h2>
        ...
        {steps.map((step) => (
          <Card key={step.number} className="border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
            <CardContent className="p-6 text-center">
              <div className="w-16 h-16 bg-blue-300 text-[#AB056A] rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-4">
                {step.number}
              </div>
              <h3 className="text-xl font-bold text-[#AB056A] mb-3">{step.title}</h3>
              <p className="text-[#3F96E6]">{step.description}</p>
            </CardContent>
          </Card>
        ))}
      </div>
