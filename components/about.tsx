    ...
    <section id="about" className="py-16 md:py-24 bg-white">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-accgk-blue">About ACCGK</h2>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative rounded-xl overflow-hidden shadow-xl h-[400px]">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-accgk-blue/80 to-transparent flex items-end">
          ...
          <div className="md:col-span-2 mt-8">
            <div className="bg-gray-50 p-8 rounded-lg border border-gray-100 shadow-sm">
              <h3 className="text-xl font-semibold mb-4 text-accgk-blue">Our Mission</h3>
              <ul className="space-y-4">
                <li className="flex items-start">
                  <div className="flex-shrink-0 w-6 h-6 rounded-full bg-accgk-pink flex items-center justify-center text-white font-bold mr-3 mt-0.5">
                    1
                  </div>
